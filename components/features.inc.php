<section class="feature gradient">
      ...
      <div class="container">
        <div class="row ">
          <div class="col-md-4">
            <img id="asset" src="img/asset.png" alt="" />
          </div>

          <div class="col-md-2"></div>

          <div class="col-md-4">
            <h1 class="my-3">Introducing Budget Tracker</h1>
            <p class="my-4">
              It's simple yet functional design allows 
              for quick and easy tracking. You will never
              forget to track your expenses again!
            </p>
            <ul>
              <li>Best for Personal Use & Business</li>
