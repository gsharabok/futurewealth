      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            ...
            <p>
              Here you can learn about trending investment ideas and advice from our experts.
            </p>
          </div>
        </div>
        <div class="row my-3 g-3">
          <div class="col-md-4">
            <img src="img/op1_stock.jpg" alt="Gallery image" class="img-fluid" />
          </div>
          <div class="col-md-4">
            <img src="img/op2_house.jpeg" alt="Gallery image" class="img-fluid" />
          </div>
          <div class="col-md-4">
            <img src="img/op3_crypto.jpg" alt="Gallery image" class="img-fluid" />
          </div>
        </div>
        <div class="row mt-5 justify-content-end">
          <div class="col-md-2">
            <button type="button" class="btn btn-outline-secondary">
              <a id ="seeworks" href="services.php">See all works</a>
            </button>
          </div>
        </div>
      </div>
